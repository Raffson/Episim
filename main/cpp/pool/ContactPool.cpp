...
ContactPool::ContactPool(const stride::ContactPool &old) {
        m_pool_id = old.m_pool_id;
        m_pool_type = old.m_pool_type;
        m_index_immune = old.m_index_immune;
        m_members = old.m_members;
        m_community = old.m_community;
        m_household = old.m_household;
}
